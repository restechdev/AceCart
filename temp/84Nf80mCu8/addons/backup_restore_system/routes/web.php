...
use App\Http\Controllers\Payment\SepehrpayController;
use App\Http\Controllers\Payment\MellatpayController;
//me end
...
////        Route::post('/backups/check_share_modal', 'check_share_modal')->name('backups.check_share_modal');
...
//
//});
////Route::get('/backups/cronbackup', [BackupController::class,'cronbackup'])->name('backups.cronbackup');
...
Route::group(['middleware' => ['user', 'verified', 'unbanned']], function () {
    ...
    Route::controller(HomeController::class)->group(function () {
        ...
        //me add
        Route::post('/user/update-theme-color', 'userProfileUpdateThemeColor')->name('user.profile.update.theme.color');
        //me end
...
//         Route::post('/get-cities', 'getCities')->name('get-city');
        ...
        //me add
        Route::post('/get-cities-latlong', 'getCitiesLatLong')->name('get-cities-latlong');
        //me end
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//me add
//zarinpal and sepehrpayl and mellatpay


// Route::post('/zarinpal-pay', 'ZarinpalController@zarinpalpay')->name('zarinpal-pay');
// Route::get('/zarinpal-callback', 'ZarinpalController@zarinpalCallback')->name('zarinpal-callback');


//Route::controller(ZarinpalController::class)->group(function () {
//    Route::get('/zarinpal-pay', 'showForm');
//    Route::get('/zarinpal-pay/success/{id}', 'paymentSuccess');
//    Route::get('/zarinpal-pay/failure/{id}', 'paymentFailure');
//});

Route::controller(ZarinpalController::class)->group(function () {
    // Route::post('/zarinpal-pay', 'ZarinpalController@zarinpalpay')->name('zarinpal-pay');
    Route::get('/zarinpal-callback', 'zarinpalCallback')->name('zarinpal-callback');
});
Route::controller(SepehrpayController::class)->group(function () {
    // Route::post('/sepehrpay-pay', 'SepehrpayController@sepehrpaypay')->name('sepehrpay-pay');
    Route::get('/sepehrpay-callback', 'sepehrpayCallback')->name('sepehrpay-callback');
});
Route::controller(MellatpayController::class)->group(function () {
    // Route::post('/mellatpay-pay', 'MellatpayController@mellatpaypay')->name('mellatpay-pay');
    Route::get('/mellatpay-callback', 'mellatpayCallback')->name('mellatpay-callback');
});
//me end
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
